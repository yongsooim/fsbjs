...
let loader = new ex.Loader(Object.keys(resources).map(key => resources[key]));
...
let maplistarr :FsbMapResource[]
for(let i = 0 ; i < mapList.length ; i++){
    maplistarr[i] = new FsbMapResource(assetRootPath + 'mapset/tmj/' + mapList[i])
}

loader.addResources(maplistarr)
...
loader.playButtonText = '시작 Enter'
...
var mapClicked = function() {
    ...
    game.currentScene.tileMaps.forEach(t => {
     ...
     maplistarr[parseInt(this.innerText.slice(0,4))].addTiledMapToScene(game.currentScene)
