...
class Player extends Actor {
  ...
  checkWhileMove(deltaPixel: number) {
    ...
    const deltaVector = d2v(this.direction).scale(6)
  ...
  setSheet() {
    this.walkAnimation['Up'] = AnimationfromSpriteSheet(playerWalkSheet[this.showingCharacterIndex], [1, 2, 1, 0, 3, 4, 3, 0], 1000 / 15 , AnimationStrategy.Loop)
    this.walkAnimation['Down'] = AnimationfromSpriteSheet(playerWalkSheet[this.showingCharacterIndex], [8, 7, 6, 9, 10, 9, 6, 7], 1000 / 15 , AnimationStrategy.Loop)
    this.walkAnimation['Left'] = AnimationfromSpriteSheet(playerWalkSheet[this.showingCharacterIndex], [14, 13, 12, 15, 16, 15, 12, 13], 1000 / 15 , AnimationStrategy.Loop)
    this.walkAnimation['Right'] = AnimationfromSpriteSheet(playerWalkSheet[this.showingCharacterIndex], [20, 19, 18, 21, 22, 21, 18, 19], 1000 / 15 , AnimationStrategy.Loop)
